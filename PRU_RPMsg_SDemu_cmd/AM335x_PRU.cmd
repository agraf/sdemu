...
MEMORY
{
	...
	PRU_DMEM_0_1	: org = 0x00000000 len = 0x00001f80 CREGISTER=24 /* 8kB PRU Data RAM 0_1 */
	PRU_DMEM_1_0	: org = 0x00002000 len = 0x00001f00	CREGISTER=25 /* 8kB PRU Data RAM 1_0 */

	PRU_DMEM_FAST	: org = 0x00001f80 len = 0x00000080	CREGISTER=15 /* Some data at top of AS */
	PRU_DMEM_DATA	: org = 0x00003f00 len = 0x00000080	CREGISTER=14 /* Some data at top of AS */
